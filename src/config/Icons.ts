...
export const ArchIcon = Icons["arch"];
export const ArchColor = IconsColors["arch"]
export const PremiereIcon = Icons["premiere"];
export const PremiereColor = IconsColors["premiere"]
export const AuditionIcon = Icons["audition"];
export const AuditionColor = IconsColors["audition"]
export const LightroomIcon = Icons["lightroom"];
export const LightroomColor = IconsColors["lightroom"]
export const PhotoshopIcon = Icons["photoshop"];
export const PhotoshopColor = IconsColors["photoshop"]
export const PythonIcon = Icons["python"];
export const FlaskColor = IconsColors["flask"]